...
function getValues() {
  let a = document.getElementById("inputZero").value;
  let b = document.getElementById("inputOne").value;
  let c = document.getElementById("inputTwo").value;
  let d = document.getElementById("inputThree").value;
